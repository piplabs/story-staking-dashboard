...
import { GetValidatorDelegationsParams, GetValidatorDelegationsResponse } from '@/lib/types/validatorApiTypes'
...
export function useValidatorDelegations(params: GetValidatorDelegationsParams) {
  ...
  return useQuery<GetValidatorDelegationsResponse | undefined>({
    queryKey: ['validatorDelegations', paramsWithDefault.validatorAddr, paramsWithDefault.sortDescending],
